...
<head>
    ...
    <title>DevCup | {{ __('welcome.Register') }}</title>
...
<div class="register-card">
    ...
    <form action="{{ route('register') }}" method="POST">
        ...
        <div class="form-group">
            <label>{{ __('welcome.Higher education institution') }}</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label>{{ __('welcome.Confirm') }}</label>
                <input type="password" name="password_confirmation" class="form-input" placeholder="••••••••" required>
            </div>
        </div>

        <button type="submit" class="btn-register">{{ __('welcome.Register') }}</button>
    </form>
