    ...
    <script>
        ...
        function addRow() {
            ...
            let row = `<tr>
                ...
                <td><textarea name="test_input[]" class="example-textarea" placeholder="Masalan: 2 3" required></textarea></td>
                <td><textarea name="test_output[]" class="example-textarea" placeholder="Masalan: 5" required></textarea></td>
                <td style="text-align: center; padding-top: 22px;">
